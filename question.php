...
/**
 * Hybrid question definition class.
 *
 * @package    qtype
 * @subpackage hybrid
...
/**
 * Represents an hybrid question.
 *
 * @copyright  2009 The Open University
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class qtype_hybrid_question extends question_with_responses {
    ...
    // Add the 2 properties to the question definition.
    // public $proctored_exam;
    public $upload_exam;
    // QRMOOD-37.
     ...
     * @return qtype_hybrid_format_renderer_base the response-format-specific renderer.
     */
    public function get_format_renderer(moodle_page $page) {
        return $page->get_renderer('qtype_hybrid', 'format_' . $this->responseformat);
    }
    ...
    public function summarise_response(array $response) {
        ...
        if (isset($response['attachments']) && $response['attachments']) {
            ...
            if ($attachedfiles) {
                $output .= get_string('attachedfiles', 'qtype_hybrid', implode(', ', $attachedfiles));
            }
        }
        return $output;
    }
    ...
    public function check_file_access($qa, $options, $component, $filearea, $args, $forcedownload) {
        ...
        } else if ($component == 'qtype_hybrid' && $filearea == 'graderinfo') {
